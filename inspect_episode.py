"""Visualize a collected episode: renders ego-view MP4 from stored frames."""
import os
import pickle
import sys
...
# Sim runs at 200 Hz; subsample to 25 fps → real-time speed
SIM_HZ = 200
TARGET_FPS = 25
STRIDE = SIM_HZ // TARGET_FPS  # 8

h, w = ep.steps[0].rgb_ego.shape[:2]
